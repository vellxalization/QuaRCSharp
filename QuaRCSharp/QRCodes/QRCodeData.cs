...
public class QRCodeData
{
    ...
    private static readonly int[,] AvailableDataBits =
    {
    ...
    public static int GetNumberOfCorrectionBlocks(QRCodeVersion version, CorrectionLevel correction) => NumberOfCorrectionBlocks[(int)correction, version - 1];
    private static readonly int[,] NumberOfCorrectionBlocks =
    {
